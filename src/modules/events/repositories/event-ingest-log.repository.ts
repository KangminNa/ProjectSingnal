...
import { eventIngestLogs } from '@infrastructure/database/schema';
import {
  EventIngestLogRepository as IEventIngestLogRepository,
  CreateEventIngestLogInput,
  EventIngestLog,
} from '@domain/ports/outbound/repositories/event-ingest-log.repository.port';

@Injectable()
export class EventIngestLogRepository implements IEventIngestLogRepository {
